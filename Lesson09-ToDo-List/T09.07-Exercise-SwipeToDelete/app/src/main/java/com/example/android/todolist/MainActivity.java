    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                uri = uri.buildUpon().appendPath(Integer.toString(idToDelete)).build();

                // TODO (2) Delete a single row of data using a ContentResolver
                ContentResolver contentResoolver = getContentResolver();
                contentResoolver.delete(uri, null, null);
