...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerViewRV = (RecyclerView)findViewById(R.id.rv_numbers);
        ...
        mRecyclerViewRV.setAdapter(mAdapter);
    }
}
